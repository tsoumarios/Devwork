<nav x-data="{ open: false }" class="border-b border-gray-100 main-nav">
        ...
        <div class="flex justify-between h-16 nav-in-wr">
            <div style="width:100%" class="flex justify-between max-w-7xl">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <x-jet-nav-link class="text-white menu--item" href="{{ route('home') }}" :active="request()->routeIs('home')">
                            <div class="item-img">
                                <img src="{{ URL::to('/') }}/images/icon_home.png" alt="icon_home">
                            </div>
                            <div class="item-text">
                                    Home
                            </div>
                        ...
                        <x-jet-nav-link class="text-white menu--item" href="{{ route('blog') }}" :active="request()->routeIs('blog')">
                            <div class="item-img">
                                <img src="{{ URL::to('/') }}/images/icon_blog.png" alt="icon_blog">
                            </div>
                            <div class="item-text">
                                Blog
                            </div>
                        ...
                        <x-jet-nav-link class="text-white menu--item"  href="{{ route('books') }}" :active="request()->routeIs('books')">
                            <div class="item-img">
                                <img src="{{ URL::to('/') }}/images/icon_books.png" alt="icon_books">
                            </div>
                            <div class="item-text">
                                    Books
                            </div>
                    ...
                    @guest
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <x-jet-nav-link class="text-white" href="{{  route('register')  }}" :active="request()->routeIs('register')">
                                {{ __('Register') }}
                            </x-jet-nav-link>
                        </div>
                    @endguest
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link class="text-white" href="{{ route('home') }}" :active="request()->routeIs('home')">
                Home
